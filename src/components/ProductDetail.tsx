...
import { ArrowLeft, Package, MapPin, Clock, AlertCircle, CheckCircle, AlertTriangle } from 'lucide-react';
...
const productDetails: Record<string, {
  ...
  'Feldbetten': {
    ...
    procurement: {
      ...
      leadTime: '2-4 Wochen',
      suppliers: 'THW-Beschaffung, Katastrophenschutz Bayern, diverse Online-Händler',
    },
    lastInspection: {
      date: '15. Oktober 2025',
      inspector: 'M. Schmidt (THW)',
        ...
        <Card className="lg:col-span-1 p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-2xl">{item.available} {item.unit}</p>
            </div>
            <div>
              <Label className="text-slate-600">Mindestbestand</Label>
              <p className="text-xl text-slate-700">{item.minStock} {item.unit}</p>
            </div>
            <div>
            ...
            <div>
              <Label className="text-slate-600">Zuletzt aktualisiert</Label>
